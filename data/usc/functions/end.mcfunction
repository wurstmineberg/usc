...
execute if entity @p[team=gold,gamemode=survival,scores={health=1..}] run tellraw @a {"text":"","extra":[{"text":"[USC] ","color":"gold"},{"text":"Team Acedia","color":"gold"},{"text":" wins!","color":"gold"}]}
...
execute if entity @p[team=aqua,gamemode=survival,scores={health=1..}] run tellraw @a {"text":"","extra":[{"text":"[USC] ","color":"gold"},{"text":"Team Otherside","color":"aqua"},{"text":" wins!","color":"gold"}]}
...
execute if entity @p[team=gray,gamemode=survival,scores={health=1..}] run tellraw @a {"text":"","extra":[{"text":"[USC] ","color":"gold"},{"text":"Team PdU","color":"gray"},{"text":" wins!","color":"gold"}]}
...
execute if entity @p[team=dark_red,gamemode=survival,scores={health=1..}] run tellraw @a {"text":"","extra":[{"text":"[USC] ","color":"gold"},{"text":"Team Eldin","color":"dark_red"},{"text":" wins!","color":"gold"}]}
execute if entity @p[team=dark_green,gamemode=survival,scores={health=1..}] run tellraw @a {"text":"","extra":[{"text":"[USC] ","color":"gold"},{"text":"Team Zucchini","color":"dark_green"},{"text":" wins!","color":"gold"}]}
...
execute if entity @p[team=black,gamemode=survival,scores={health=1..}] run tellraw @a {"text":"","extra":[{"text":"[USC] ","color":"gold"},{"text":"Team Witch Hat","color":"black"},{"text":" wins!","color":"gold"}]}
