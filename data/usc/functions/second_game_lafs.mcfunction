...
execute if entity @p[scores={lafsChosen=1},team=dark_aqua] run scoreboard players set teamParticipatesDarkAqua variables 1
...
execute if entity @p[scores={lafsChosen=1},team=light_purple] run scoreboard players set teamParticipatesLightPurple variables 1
...
execute if entity @p[scores={lafsChosen=1},team=green] run scoreboard players set teamParticipatesGreen variables 1
...
execute if entity @p[scores={lafsChosen=1},team=red] run scoreboard players set teamParticipatesRed variables 1
...
execute if entity @p[scores={lafsChosen=1},team=yellow] run scoreboard players set teamParticipatesYellow variables 1
...
execute if entity @p[scores={lafsChosen=1},team=gray] run scoreboard players set teamParticipatesGray variables 1
...
execute if entity @p[scores={lafsChosen=1},team=dark_blue] run scoreboard players set teamParticipatesDarkBlue variables 1
...
execute if entity @p[scores={lafsChosen=1},team=gold] run scoreboard players set teamParticipatesGold variables 1
...
execute if entity @p[scores={lafsChosen=1},team=dark_red] run scoreboard players set teamParticipatesDarkRed variables 1
...
execute if entity @p[scores={lafsChosen=1},team=dark_green] run scoreboard players set teamParticipatesDarkGreen variables 1
...
execute if entity @p[scores={lafsChosen=1},team=aqua] run scoreboard players set teamParticipatesAqua variables 1
...
execute if entity @p[scores={lafsChosen=1},team=dark_gray] run scoreboard players set teamParticipatesDarkGray variables 1
...
execute if entity @p[scores={lafsChosen=1},team=dark_purple] run scoreboard players set teamParticipatesDarkPurple variables 1
...
execute if entity @p[scores={lafsChosen=1},team=blue] run scoreboard players set teamParticipatesBlue variables 1
...
execute if entity @p[scores={lafsChosen=1},team=black] run scoreboard players set teamParticipatesBlack variables 1
...
execute if entity @p[scores={lafsChosen=1},team=white] run scoreboard players set teamParticipatesWhite variables 1
